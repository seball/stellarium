...
function replaceImageColor(image, imageData, color, particle) {
  ...
  return new Promise((resolve) => {
    ...
    const errorHandler = () => __async(null, null, function* () {
      domUrl.revokeObjectURL(url);
...
function addLoadImageToEngine(engine) {
  ...
  engine.loadImage = (data) => __async(null, null, function* () {
...
function loadLifeUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.1");
    yield engine.addParticleUpdater("life", (container) => __async(null, null, function* () {
...
function loadLinksInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("particlesLinks", (container) => __async(null, null, function* () {

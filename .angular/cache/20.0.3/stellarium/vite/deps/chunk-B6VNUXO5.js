...
var Engine = class {
  ...
  load(params) {
    return __async(this, null, function* () {
      const id = params.id ?? params.element?.id ?? `tsparticles${Math.floor(getRandom() * loadRandomFactor)}`, { index, url } = params, options = url ? yield getDataFromUrl({ fallback: params.options, url, index }) : params.options;
...
//# sourceMappingURL=chunk-B6VNUXO5.js.map
